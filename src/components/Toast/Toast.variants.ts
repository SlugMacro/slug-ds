...
export const toasterClassNames = {
  toast:
    "group border border-border-neutral-subtle bg-bg-canvas text-fg-primary rounded-lg shadow-lg",
  title: "text-sm font-medium text-fg-primary",
  description: "text-sm text-fg-secondary",
  actionButton:
    "bg-bg-primary text-fg-on-light text-sm font-medium rounded-md px-3 py-1.5 hover:bg-bg-primary-hover",
  cancelButton:
    "bg-bg-surface text-fg-secondary text-sm font-medium rounded-md px-3 py-1.5 border border-border-neutral-subtle hover:bg-bg-neutral-muted-hover",
  closeButton:
    "border border-border-neutral-subtle bg-bg-canvas text-fg-secondary hover:text-fg-primary",
